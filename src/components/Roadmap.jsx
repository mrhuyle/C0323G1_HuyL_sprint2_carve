          ...
          >
            <div>
              <div className="w-10 h-10 mx-auto mb-4">
                <span className="w-full h-full text-4xl text-brandPrimary">
                  {period.id}
                </span>
              </div>
              <div className="w-20 h-20 mx-auto mb-4">
                <period.img className="w-full h-full text-buttonColor" />
              </div>
              <h4 className="px-2 mb-2 text-2xl font-bold text-blue-800">
                {period.title}
              </h4>
