...
const UserSetting = () => {
  ...
  //   For upload img
  const [uploadedImageUrl, setUploadedImageUrl] = useState(user?.img);
  ...
  const handleImageUpload = async (secureUrl) => {
    ...
    try {
      const response = await userServices.saveImg(auth?.accessToken, data);
      ...
      if (err?.response.status == 409) {
        Swal.fire({
          title: "Lỗi lưu ảnh. Vui lòng thử lại",
          icon: "error",
          timer: 2000,
        });
      }
        ...
        <div className="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
          ...
          <div className="col-span-full xl:col-auto">
            <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
              <div className="flex-col items-center gap-2 sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
                <div className="flex items-center justify-around w-full">
                  <img
                    className="mb-4 rounded-lg w-28 h-28 sm:mb-0 xl:mb-4 2xl:mb-0"
                    src={uploadedImageUrl || user?.img}
                    alt="User picture"
                  />
